...
static constexpr char const *lifecycle_node = "talker";
...
static constexpr char const *node_get_state_topic = "talker/get_state";
static constexpr char const *node_change_state_topic = "talker/change_state";
