...
#include "floor_robot_msgs/msg/floor_robot_poses.hpp"
...
public:
    ListenerDemo(std::string node_name) : Node(node_name)
    {
        ...
        listen_timer_ = this->create_wall_timer(0.1s, std::bind(&ListenerDemo::listen_timer_cb_, this));

        // publisher
        robot_poses_pub_ = this->create_publisher<floor_robot_msgs::msg::FloorRobotPoses>("floor_robot_poses", 100);
    }
...
private:
    ...
    /*!< Publisher object */
    rclcpp::Publisher<floor_robot_msgs::msg::FloorRobotPoses>::SharedPtr robot_poses_pub_;
